...
public class Administrateur extends Utilisateur{
    ...
    public Administrateur(long id_utilisateur, String password, String email, String pseudo, int etat_compte, int num_tel, String nom, String prenom, String date_naissance, int role) {
