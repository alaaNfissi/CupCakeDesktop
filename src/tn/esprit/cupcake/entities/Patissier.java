...
public class Patissier extends Utilisateur{
    ...
    public Patissier(long id_utilisateur, String password, String email, String pseudo, int etat_compte, int num_tel, String nom, String prenom, String date_naissance, int role) {
        super(id_utilisateur, password, email, pseudo, etat_compte, num_tel, nom, prenom, date_naissance, role);
    }

     public Patissier(String password, String email, String pseudo, int etat_compte, int num_tel, String nom, String prenom, String date_naissance,int role) {
        super(password, email, pseudo, etat_compte, num_tel, nom, prenom, date_naissance, role);
    }
     public Patissier(String password, String email, String pseudo, int num_tel, String nom, String prenom, String date_naissance) {
        super(password, email, pseudo, num_tel, nom, prenom, date_naissance);
    } 

    public Patissier(long id_utilisateur, String email, int etat_compte, int num_tel, String nom, String prenom, String date_naissance) {
